...
<div class="relative min-h-[88vh] rounded-3xl overflow-hidden p-4 sm:p-6 lg:p-10 border border-slate-200/60 shadow-xl bg-cover bg-center"
    ...
    <div class="relative z-10 max-w-6xl mx-auto space-y-6">
        ...
        <div class="glass-hud rounded-2xl border border-white/40 p-5 sm:p-6 shadow-lg">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-1 text-xs sm:text-sm font-medium text-slate-500">Overview of all scheduled patient consultations, assigned dental surgeons, and booking details.</p>
                </div>
        ...
        <!-- Main Appointments Data Grid Table -->
                ...
                <table class="w-full border-collapse text-left text-xs text-slate-600">
                    <thead>
                        <tr class="border-b border-slate-200 bg-slate-100/60 font-black uppercase tracking-wider text-slate-400 text-[10px]">
                            ...
                            <th scope="col" class="px-5 py-4">Treatment</th>
                            <th scope="col" class="px-5 py-4">Fee (Inc. 20% Tax)</th>
                            <th scope="col" class="px-5 py-4">Date and Time</th>
                    ...
                    <%
                        ...
                        try {
                            ...
                            // UPDATED SQL QUERY: Selected p.address AS patient_address
                    ...
                    %>
                        <tr class="app-row transition-all duration-200 hover:bg-sky-50/40">
                            ...
                            <!-- Patient Details (Includes Name, ID, Phone, and Address) -->
                            <td class="px-5 py-4">
                            ...
                            <!-- Treatment Category -->
                            <td class="whitespace-nowrap px-5 py-4">
                                <span class="inline-flex items-center gap-1 rounded-md bg-slate-100 px-2.5 py-1 text-[11px] font-bold text-slate-700 border border-slate-200">
                                    <i class="fa-solid fa-tooth text-[10px] text-orange-500"></i>
                            ...
                            <td class="whitespace-nowrap px-5 py-4 font-mono text-xs font-black text-slate-900">
                                <div class="flex flex-col">
                                    ...
                                    <span class="text-[9px] text-slate-400 font-sans font-normal">Base: <%= String.format("%,.2f", baseFee) %></span>
                                </div>
                            </td>
                    ...
                    %>
                        <tr>
                            <td colspan="7" class="px-6 py-16 text-center text-xs font-bold text-slate-400 bg-slate-50/30">
                    ...
                    %>
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center text-xs font-bold text-rose-600 bg-rose-50/40">
